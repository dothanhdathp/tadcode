...
- __Vectors__ cũng là một cấu trúc dữ liệu cơ bản nên cách phát triển của nó cũng tuân thủ [Iterators](cpp-initializer-list.md)
...
- [Initializer List](cpp-initializer-list.md)