...
__*Iterator*__ là Là "keo dán" giữa các thành phần của [Container](cpp-std-container.md) (std::vector, std::list, ...) với các Algorithms (sort, find).

__*Iterator*__ định hình các cấu trúc dữ liệu theo một kiểu thống nhất giúp các thuật toán xử lý giữa chúng được đồng bộ, tối giản nhất có thể về mặt ngữ nghĩa.
...
Trong các cấu trúc dữ liệu chung đều dùng **iterator** nếu chúng có các con trỏ đến các phần tử như phần tử _**begin(), end(), rbegin(), rend()**_, ...

```cpp
std::vector<int>::iterator ir; // std::vector<int>().begin()
std::set<int>::iterator ir; // std::vector<int>().begin()
std::map<int>::iterator ir; // std::vector<int>().begin()
std::list<int>::iterator ir; // std::vector<int>().begin()
std::unordered_set<int>::iterator ir; // std::vector<int>().begin()
std::unordered_map<int>::iterator ir; // std::vector<int>().begin()
...
- [_std::vector_](cpp-std-vector.md)
- [_std::set_](cpp-std-set.md)
- [_std::map_](cpp-std-map.md)
- [_std::list_](cpp-std-list.md)
- [_std::unordered_set_](cpp-std-unordered-set.md)
- [_std::unordered_map_](cpp-std-unordered-map.md)