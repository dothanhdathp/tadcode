...
| Tên                                  | Phiên Bản | Mô Tả                                                                          |
| :----------------------------------- | :-------: | :----------------------------------------------------------------------------- |
| [std::set](cpp-std-set.md)           |           | Tập hợp các phần tử **duy nhất** và **được sắp xếp**                           |
| [std::map](cpp-std-map.md)           |           | tập hợp các **cặp khóa-giá trị**, **được sắp xếp theo khóa**, khóa là duy nhất |
| [std::multiset](cpp-std-multiset.md) |           | tập hợp các phần tử được **sắp xếp**                                           |
| [std::multimap](cpp-std-multimap.md) |           | tập hợp các **cặp khóa-giá trị**, được sắp xếp theo khóa                       |
