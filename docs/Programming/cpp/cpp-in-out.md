...
> Chỉ sử dụng được từ phiên bản `C++17` đến phiên bản `C++23`. Từ `C++23`, hàm __println__ đã được phát triển trong thư viện __std__, sử dụng _marco_ này có thể gây trùng tên.
