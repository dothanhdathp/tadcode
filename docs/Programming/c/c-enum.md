...
int main() {
    println("STATE_IDLE         : %d", STATE_IDLE);
    println("STATE_PLAY         : %d", STATE_PLAY);
    println("STATE_PAUSE        : %d", STATE_PAUSE);
    println("STATE_STOP         : %d", STATE_STOP);
    println("STATE_FAST_FORWARD : %d", STATE_FAST_FORWARD);
    println("STATE_FAST_REWIND  : %d", STATE_FAST_REWIND);
    println("STATE_MAX          : %d", STATE_MAX);
    return 0;
}
```
```text title="Kết Quả"
